...
const processSteps = [
    { number: 1, title: "Consulta", desc: "Analizamos tus necesidades y objetivos." },
    { number: 2, title: "Diseño", desc: "Creamos prototipos y planificamos la solución." },
    { number: 3, title: "Desarrollo", desc: "Implementamos la solución con metodologías ágiles." },
...
function ServiceCard({ service }) {
    ...
    return (
        <div className="bg-[rgba(30,30,30,0.9)] rounded-xl p-8 text-center flex-1 min-w-[300px] max-w-[350px] shadow-xl border border-[#333] mb-6 transition-transform duration-300 hover:-translate-y-2">
            ...
            <h3 className="text-xl font-semibold mb-4 text-[#5e931a]">{service.title}</h3>
            ...
            <div className="relative h-44 bg-[rgba(20,20,20,0.7)] border-2 border-dashed border-[#5e931a] rounded-lg flex flex-col items-center justify-center mb-6 text-[#5e931a]">
                <Image src={service.img} alt={service.title} fill className="object-cover mb-2 rounded-lg" />
            </div>
...
function ProcessStep({ step }) {
    return (
        <div className="flex-1 min-w-[200px] text-center">
            <div className="w-12 h-12 bg-[#5e931a] text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">{step.number}</div>
            <h4 className="text-lg font-semibold text-[#5e931a] mb-2">{step.title}</h4>
    ...
    return (
        <div className=" min-h-screen font-sans">
            <div className="contactoHeader bg-[#5e931a] text-white text-center py-10 px-4 shadow-lg relative overflow-hidden">
                <h1 className="text-4xl md:text-5xl font-bold mb-2 drop-shadow-lg">Nuestros Servicios</h1>
                <p className="text-lg opacity-90">Soluciones tecnológicas a tu medida</p>
            </div>
            <div className="text-center py-8 px-4 max-w-2xl mx-auto text-gray-300 text-base md:text-lg">
                <p>En Dataplicity ofrecemos una amplia gama de servicios de desarrollo de software para impulsar tu negocio hacia el éxito a través de la digitalización.</p>
            </div>
            ...
            <div className="bg-[rgba(30,30,30,0.9)] rounded-xl p-10 my-12 w-[90%] max-w-5xl mx-auto shadow-2xl border border-[#333] text-center">
                <h2 className="text-2xl font-bold text-[#5e931a] mb-8">Nuestro Proceso de Desarrollo</h2>
            ...
            <div className="bg-gradient-to-br from-[#5e931a] to-[#4a7615] rounded-xl p-12 my-12 w-[90%] max-w-2xl mx-auto text-center shadow-2xl">
                ...
                <p className="mb-8 text-lg">Contáctanos hoy mismo para una consulta gratuita</p>
                <Link
                    href="/Contacto"
