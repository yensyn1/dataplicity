    ...
    <div>
      ...
      >
        <svg
          ...
          className="lucide lucide-align-justify-icon lucide-align-justify bg-transparent"
        >
          <path d="M3 12h18" />
          <path d="M3 18h18" />
          <path d="M3 6h18" />
          ...
          <div className="flex flex-col self-center text-center heading gap-[3vw]">
            <Link href={"/"}>
              <motion.h1
                ...
                className={
                  pathname === "/"
                    ? `duration-300 border-b-1 text-[#417a11]`
                    : `text-white hover:text-red-300 hover:scale-105 duration-300 `
                }
              >
                Inicio
              </motion.h1>
            ...
            <Link href={"/Servicios"}>
              <motion.h1
                ...
                className={
                  pathname === "/Servicios"
                    ? `text-[#417a11] duration-300 border-b-1 `
                    : `text-white hover:text-red-300 hover:scale-105 duration-300 `
                }
              >
                Servicios
