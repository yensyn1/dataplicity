        ...
        <main className="m-0">
            <section className="mb-8 relative ">
                <div className="flex flex-col absolute z-10 w-full h-full justify-center">
                    ...
                    <Link href={"/"} className="bg-green-600 flex w-max px-6 ml-20 py-2 rounded-xl h6 hover:scale-105 hover:-translate-y-1 transition-all duration-200">
                        Ver proyectos
                    </Link>
                </div>
            ...
            <div class="whatsapp-oval">
                <div class="whatsapp-icon">
                    <svg className="flex" width="42px" height="42px" viewBox="0 0 24 24" id="meteor-icon-kit__regular-whatsapp" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path
